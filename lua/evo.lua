...
TASKFORCES = { ['1_heli']={ units={'heli'}, }, ['1_hind']={ units={'hind'}, }, ['1_e1']={ units={'e1'}, }, ['1_e3']={ units={'e3'}, }, ['1_jeep']={ units={'jeep'}, }, ['1_1tnk']={ units={'1tnk'}, }, ['1_2tnk']={ units={'2tnk'}, }, arty={ units={'arty'}, }, humvee={ units={'jeep', 'jeep', 'e1', 'e1', 'e3', 'e3', 'e3', 'e3'}, }, tran={ units={'tran', 'e1', 'e1', 'e3', 'e3', 'e3'}, }, ['1_e2']={ units={'e2'}, }, ['1_deso']={ units={'deso'}, }, ['1_e4']={ units={'e4'}, }, ['1_shok']={ units={'shok'}, }, ['1_ftrk']={ units={'ftrk'}, }, ['1_qtnk']={ units={'qtnk_ai'}, }, ['1_3tnk']={ units={'3tnk'}, }, ['1_4tnk']={ units={'4tnk'}, }, ttnk={ units={'ttnk'}, }, v2rl={ units={'v2rl'}, }, ['1_mig']={ units={'mig'}, }, ['1_yak']={ units={'yak'}, }, ['1_zep']={ units={'zep'}, }, ['5_want']={ units={'want', 'want', 'want', 'want', 'want'}, }, ['4_fant']={ units={'fant', 'fant', 'fant', 'fant'}, }, ['2_doggie']={ units={'doggie', 'doggie'}, }, }
...
MutantBuildUnitTick = function(faction)
  ...
  if  not AUTO_BUILD then
    ...
    if PLAYER.HasPrerequisites({'evo'}) then
      if UTIL_Count('inft')<6 then
        PLAYER.Build({'inft'}, nil)
      end
...
UTIL_LoadTransports = function(transports, passengers, afterLoadFunc, afterLoadParams)
  local passengerss = {}
  for i, p in ipairs(passengers) do
    local index = (i%#transports)+1
    if passengerss[index]==nil then
      passengerss[index] = {p}
    else
      table.insert(passengerss[index], p)
    end
  end
  for i, ps in ipairs(passengerss) do
    UTIL_MoveTransportToPassengers(transports[i], passengerss[i], afterLoadFunc, afterLoadParams)
  end
end
...
UTIL_BuildTeam = function(teamName)
  ...
  --     
  if  not HasAllPrerequisites(TASKFORCES[TEAMS[teamName]['tf']]['units']) then
    return false
  end
...
UTIL_RepairUnits = function()
  ...
  for _, a in ipairs(actors) do
    if FIXABLE[a.Type]==true and a.Health<a.MaxHealth/10 and  not a.HackyAIOccupied then
      a.HackyAIOccupied = true
      a.Stop()
      a.RepairAt(fix)
    elseif FIXABLE[a.Type]==true and a.Health>=0.8*a.MaxHealth and a.HackyAIOccupied then
