...
namespace OpenRA.Mods.Common.Projectiles
{
	...
	public class RadBeamInfo : IProjectileInfo
	{
		...
		// Width was a good variable name, but for some reason, I coudn't override Width parameter to my own value.
		// I don't know if it was a temporary error of visual studio but oh well, I'm not renaming this back to width
		// cos it works, as of now.
